...
class NomorPesertaTest extends TestCase
{
    ...
    public function test_can_generate_nomor_peserta_deterministically()
    {
        ...
        KelasSiswa::create(['kelas_id' => $kelas->id, 'siswa_id' => $siswa1->id, 'tp_id' => $this->tp->id, 'smt_id' => $this->smt->id]);
        KelasSiswa::create(['kelas_id' => $kelas->id, 'siswa_id' => $siswa2->id, 'tp_id' => $this->tp->id, 'smt_id' => $this->smt->id]);
